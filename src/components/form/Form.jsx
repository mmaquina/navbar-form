      ...
      <div className="space-y-12 bg-gradient-to-bl from-violet-200 to-slate-300">
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <p className="mt-1 text-sm leading-6 text-gray-600">
            Elija aquellos campos que sean de su interés para recibir notificaciones.
          </p>
              ...
              <div className="mt-6 space-y-6">
                <div className="relative flex gap-x-3">
                  ...
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-gray-500">Recibir notificaciones sobre eventos de CARC en su ciudad.</p>
                  </div>
                </div>
                <div className="relative flex gap-x-3">
                  <div className="flex h-6 items-center">
                  ...
                  <div className="text-sm leading-6">
                    ...
                    <p className="text-gray-500">Recibir notificaciones con ofertas.</p>
                  </div>
                </div>
              </div>
            </fieldset>
